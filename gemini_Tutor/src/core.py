...
class SessionManager:
    ...
    def create_session(self, history=None):
        ...
        # Ensure history is always a list to prevent errors during session creation
...
class TutorAgent:
    ...
    def switch_model(self, new_model_name):
        ...
        # FIX: Safer access using getattr with a default empty list
    ...
    def shutdown(self):
        # FIX: Ensure history is retrieved before the session closes

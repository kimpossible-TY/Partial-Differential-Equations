...
fpath = "Preliminaries/Riemannian manifolds/Levi-chivita.typ"
...
# Write to temp file
temp_path = "Preliminaries/Riemannian manifolds/temp_lc.typ"
with open(temp_path, "w") as f:
    f.write(modified)

# Compile temp_lc.typ
res = subprocess.run(
    ["typst", "compile", "--root", ".", temp_path, "scratch/temp_lc.pdf"],
    capture_output=True,
    text=True
)
